...
- Documentation audit `2026-06-14 19:02 UTC`: fetched `main`, `MVP1`, and `MVP2`; no branch tips changed after the previous README update (`db262be`), so the branch-only notes below remain current.
