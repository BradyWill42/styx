...
- Documentation audit `2026-06-14 22:02 UTC`: fetched all remote branches (`main`, `MVP1`, and `MVP2`); no branch tips changed since the previous README audit (`e3eee70`), so the branch-only notes below remain current.
